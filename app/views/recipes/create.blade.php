...
File name: recipes/create.blade.php
Description: Returns form to create individual recipe to store method on controller--}}

@extends('layouts.main')

@section('title')
    Create New Recipe for Paula's Mystical Kitchen Alchemy
@stop
        ...
        <div id="left_content">
            <div id="main">
                <div class="form">
                    ...
                    <fieldset>
                        {{ Form::submit('Add Recipe', ['class' => 'button']) }}
                    </fieldset>
